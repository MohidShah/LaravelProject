  ...
  <table class="table table-dark table-hover">
    ...
    @foreach ($users as $user)
         <tr>
            ...
            <td><a href="delete/{{ $user->id }}" onclick="return confirm('Are you sure you want to delete this record?')"><img src="{{ asset('img/delete.png') }}" class="img-thumbnail" height="40px" width="40px"></a></td>
